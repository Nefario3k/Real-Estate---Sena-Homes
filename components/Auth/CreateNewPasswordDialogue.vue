  ...
  >
    <v-card class="authCard">
      ...
      <div class="modal_content">
        <form v-if="!accountSuccess" class="content_area">
          <header style="margin-bottom: 11px">Create New Password</header>
          <p
            style="
              text-align: center;
              width: 85%;
          ...
          <footer class="footer">
            <v-btn @click="accountSuccess = true" class="Btn">Continue</v-btn>
          </footer>
        </form>
        <div v-else class="content_area">
          ...
          <p class="greeterText">Congratulations!</p>
          <p class="subtext">Your account is ready to use</p>
          <footer class="footer">
...
.subtext {
  color: var(--greeter-color) !important;
  margin-bottom: 63px;
