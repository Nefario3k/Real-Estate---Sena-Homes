    ...
    <v-container class="footerContainer">
      <v-row class="footer_row">
        ...
        <aside class="footer_right row col-12 col-sm-12 col-md-8 col-lg-8">
          ...
          <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <ul class="footerLinkList">
              ...
              <li class="footerLink">
                <nuxt-link to="/property/residential">Residential</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/property/commercial">Commercial</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/property/off-plan">Off-plan Projects</nuxt-link>
              </li>
            </ul>
          </div>
          <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <ul class="footerLinkList">
              ...
              <li class="footerLink">
                <nuxt-link to="/account/favorite">Favorites</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/account/reviews-ratings"
                  >Reviews & Ratings</nuxt-link
                >
              </li>
            </ul>
          </div>
        ...
        <div class="col-12 footerBottomContainer">
          ...
          >
            <p class="copyrights">
              ©2022 - Sena Homes Real Estate. All rights reserved.
            </p>
